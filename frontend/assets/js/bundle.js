...
/***/ "./src/A0019-exercicios/form-control.ts":
/*!**********************************************!*\
  !*** ./src/A0019-exercicios/form-control.ts ***!
  \**********************************************/
...
function checkForEmptyFields(...inputs) {
    inputs.forEach(input => {
        if (!input.value)
            showErrorMessage(input, 'Campo não pode fucar vazio');
    });
}
...
function checkEqualPasswords(password, password2) {
    if (password.value !== password2.value) {
        showErrorMessage(password, 'Senhas incorretas');
        showErrorMessage(password, 'Senhas incorretas');
    }
}
...
function showErrorMessage(input, msg) {
    ...
    const hideErrorMessage = formFields.querySelector('.error-message');
    hideErrorMessage.innerText = msg;
    formFields.classList.add(SHOW_ERROR_MESSAGES);
}
function showIdSendForm(form) {
    let send = true;
    form.querySelectorAll('.' + SHOW_ERROR_MESSAGES)
        .forEach(() => (send = false));
    return send;
...
/*!**************************************************!*\
  !*** ./src/A0019-exercicios/A0019.exercicios.ts ***!
  \**************************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form-control */ "./src/A0019-exercicios/form-control.ts");
